...
MPI_PATH = "/sdcc/u/eyildirim/NPB3.4.2/NPB3.4-MPI/bin/"
OMP_PATH = "/sdcc/u/eyildirim/NPB3.4.2/NPB3.4-OMP/bin/"
HYBRID_PATH = "/sdcc/u/eyildirim/NPB3.4.2-MZ/NPB3.4-MZ-MPI/bin/"

mpi_apps = ["bt", "cg", "ep", "ft", "is", "lu", "mg", "sp"]
omp_apps = ["bt", "cg", "ep", "ft", "is", "lu", "mg", "sp", "ua"]
