...
RESOURCE_JSON = "resource_anl.json"
#TASKID_SEED = 10
...
def init(num_nodes, runtime_mins, service_path, venv_path):
    ...
    PILOT_DESCRIPTION = {
    'resource': 'anl.polaris',  # OR 'bnl.ic2_debug'
    'project': 'UNNPredCloudHPC',
    'nodes': num_nodes,
...
def submit_tasks(session, tmgr, task_desc_list, num_tasks, inter_arrival_times, seed_num): # multiple sessions must be possible
    ...
    for i in range(num_tasks):
        ...
        print("Submitted task:", task.description["executable"], task.description['arguments'],
...
if __name__ == "__main__":
    ...
    # possiblle SEED combinations to use [10, 35, 62, 89, 22, 1, 709, 232, 677,23]
    #seed_list = [10, 35, 62, 89, 22]
    #seed = 35
    seed_list = [10]

    for seed in seed_list:
        allocated_num_nodes = 100
        allocated_time_mins = 180
        num_tasks_to_submit = 1000
        mean_inter_arrival_time_secs = 1
        ...
        session, pilot, tmgr = init(allocated_num_nodes,
                                allocated_time_mins,
                                "/home/eyildirim/workload_generator/",
                                "/home/eyildirim/venvs/2024-04-29/")
        ...
        write_workload_data(task_json_list, 
                        ...
                        pilot.uid,
                        allocated_num_nodes,
                        "workloads_mixed100.json")
        write_system_load_data(session.uid,
                           pilot.uid,
                           allocated_num_nodes,
                           "mixed-tasks"+str(seed),
                           "hpc_polaris",
                           "system_load_mixed100.json")
